...
import humoLogo from './humo-logo.png';

const Card = () => {
  return (
    <div className="card-container transform scale-125 sm:scale-150 origin-center lg:origin-right">
      <div className="flip-card">
        <div className="flip-card-inner">
          <div className="flip-card-front">
            <p className="heading_8264">HUMO</p>
            <Image src={humoLogo} alt="Humo Logo" className="logo" width={60} height={20} style={{ objectFit: 'contain' }} />
      ...
      <style>{`
        ...
        .valid_thru {
          position: absolute;
          font-weight: bold;
          top: 6h35.8em; /* Original typo from the prompt? No, they used 635.8em which overflowed? I'll fix it to 6.35em */
          top: 6.35em;
          font-size: .3em;
          left: 14.3em;
        }
